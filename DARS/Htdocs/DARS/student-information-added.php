<html lang="en">
	...
	<body>
		...
		<section class="input">
			...
			<form method="post" action="submit-student-information.php">
				<form class="input-form">
					...
					<br>
					<input class="form-control" name="student-id" type="text" required>
					<br><br>
					<label>Student Name</label>
					<br>
					<input class="form-control" name="student-name" type="text" required>
					<br><br>
					<label>Email</label>
					<br>
					...
					<br>
					<input class="form-control" name="phone-number" type="text" required>
					<br><br>
					<label></label>
					<br>
