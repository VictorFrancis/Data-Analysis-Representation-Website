	<?php  
			...
			if (isset($_POST["compare-btn"])) {
				$year = $_POST["year"];
				$universityOne = $_POST["universityOne"];
				$universityTwo = $_POST["universityTwo"];
				$universityThree = $_POST["universityThree"];
				$universityFour = $_POST["universityFour"];
				$universityFive = $_POST["universityFive"];
				...
				$sql = "SELECT * FROM `UNIVERSITY` WHERE `University Name` IN("."'".$universityOne."',"."'".$universityTwo."',"."'".$universityThree."',"."'".$universityFour."',"."'".$universityFive."') AND `Year` IN('".$year."')";
    			//echo $sql;
    			$result = mysqli_query($mysqli, $sql);

    			//$criteria = "'".$criteria."'";
    			while ($row = mysqli_fetch_array($result)) {
    				$universityNames = $universityNames . '"'. $row['University Name'] .'",';
		...
		<section class="nav-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<ul>
							<a href="compare-university-admin.php"><li>Compare Univerties</li></a>
							<a href="previous-record-admin.php"><li>University previous records</li></a>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<form method="post">
							<div class="row">
							    <div class="col-md-12">
							    	<select class="form-control" id="formGroupDropdown" name="year">
							    ...
							    <div class="col-md-12">
							    	<select class="form-control " id="formGroupDropdown " name="universityOne">
							    ...
							    <div class="col-md-12">
							    	<select class="form-control " id="formGroupDropdown " name="universityTwo">
								    	<option>--Select University--</option>
								      	<option>Independent University Bangladesh</option>
								      	<option>North South University</option>
								      	<option>Brac University</option>
							    ...
							    <div class="col-md-12">
							    	<select class="form-control " id="formGroupDropdown " name="universityThree">
								    	<option>--Select University--</option>
								      	<option>Independent University Bangladesh</option>
								      	<option>North South University</option>
								      	<option>Brac University</option>
							    ...
							    <div class="col-md-12">
							    	<select class="form-control " id="formGroupDropdown " name="universityFour">
								    	<option>--Select University--</option>
								      	<option>Independent University Bangladesh</option>
								      	<option>North South University</option>
								      	<option>Brac University</option>
							    ...
							    <div class="col-md-12">
							    	<select class="form-control " id="formGroupDropdown " name="universityFive">
								    	<option>--Select University--</option>
								      	<option>Independent University Bangladesh</option>
								      	<option>North South University</option>
								      	<option>Brac University</option>
							    ...
							    <div class="col-md-12">
								    <select class="form-control" id="formGroupDropdown" name="criteria">
									    ...
									    <option>University land(Acre)</option>
									    <option>University Physical Structure(owned)</option>
									    <option>No. Of Schools</option>

									    <option>Course</option>
									    <option>Available Seat</option>
									    <option>University Physical Structure(rented)</option>
									</select>
								</div>
